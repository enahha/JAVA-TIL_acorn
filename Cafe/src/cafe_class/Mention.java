public class Mention {
	...
	private final String MENT5_ORDER_AGAIN 	= "주문이 취소되었습니다. 다시 입력해주세요";
	private final String MENT6_YN_ONLY		= "y 혹은 n을 입력바랍니다";
	private final String MENT7_NUMBER_ONLY 	= "숫자를 입력바랍니다";
	private final String MENT8_PAY = "\n결제를 시작합니다.";
	private final String MENT9_PAY_TOOL = "1.카드 2.현금 선책 (주문취소 c): ";
